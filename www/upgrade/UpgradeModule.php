...
class UpgradeModule extends Module {
    ...
    function info() {
        ...
        $this->f3->set('simpleid_docs', $this->t('For more detailed information, see the <a href="!url">SimpleID documentation</a>.', array('!url' => 'http://simpleid.koinic.net/docs/1/upgrading/')));
        ...
        $this->f3->set('step2', $this->t('Install your new files in the appropriate location, as described in the <a href="!url">SimpleID documentation</a>.', array('!url' => 'http://simpleid.koinic.net/docs/1/installing/')));
